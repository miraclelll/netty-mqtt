package com.peachl.nettyserver.utils;
...
//    public static Logger appExceptionLog=LogManager.getLogger("error_113");
    ...
    public static MqttFixedHeader CONNACK_HEADER = new MqttFixedHeader(MqttMessageType.CONNACK, false, MqttQoS.AT_LEAST_ONCE,false,0);
    public static MqttFixedHeader SUBACK_HEADER = new MqttFixedHeader(MqttMessageType.SUBACK, false,MqttQoS.AT_LEAST_ONCE,false,0);
    public static MqttFixedHeader PUBACK_HEADER = new MqttFixedHeader(MqttMessageType.PUBACK, false,MqttQoS.AT_LEAST_ONCE,false,0);
    public  static MqttFixedHeader PUBLISH_HEADER = new MqttFixedHeader(MqttMessageType.PUBLISH, false,MqttQoS.AT_LEAST_ONCE,false,0);
    public static MqttFixedHeader UNSUBACK_HEADER = new MqttFixedHeader(MqttMessageType.UNSUBACK, false,MqttQoS.AT_LEAST_ONCE,false,0);
    public static MqttFixedHeader PINGRESP_HEADER = new MqttFixedHeader(MqttMessageType.PINGRESP, false,MqttQoS.AT_LEAST_ONCE,false,0);
    public static MqttFixedHeader PUBREC_HEADER = new MqttFixedHeader(MqttMessageType.PUBREC, false,MqttQoS.AT_LEAST_ONCE,false,0);
